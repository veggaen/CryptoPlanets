                              ...
                              <div className="flex items-center gap-3 min-w-0">
                                <div className="w-9 h-9 rounded-full overflow-hidden border border-white/10 bg-white/5 flex items-center justify-center shrink-0">
                                  {icon ? (
                                    ...
                                    <div className="text-[11px] font-bold text-white/70">{String(symbol).slice(0, 2).toUpperCase()}</div>
                                  )}
                                </div>
                    ...
                    {providerMeta?.lockedPrimaryProvider === 'coinmarketcap' && primaryProvider === 'coinmarketcap' && (
                      <div className="mt-3 rounded-2xl border border-red-500/20 bg-red-500/10 p-3">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <button
                            type="button"
                            className="inline-flex items-center justify-center w-8 h-8 -mr-1 -mt-1 rounded-xl text-white/45 hover:text-white/70 hover:bg-white/5 focus:outline-none focus:ring-1 focus:ring-white/15"
                            aria-label="Why CoinMarketCap is locked"
                            aria-expanded={cmcLockedInfoOpen}
                            onClick={() => setCmcLockedInfoOpen((v) => !v)}
                          >
                        ...
                        {cmcLockedInfoOpen && (
                          <div className="mt-2 rounded-xl border border-white/10 bg-black/30 p-3">
                            ...
                            <div className="mt-1 text-[11px] text-white/70 leading-snug">
                              CoinMarketCap API access is paid. Enabling public access can cost roughly <span className="text-white/85 font-medium">$948–$3,588/year</span>
